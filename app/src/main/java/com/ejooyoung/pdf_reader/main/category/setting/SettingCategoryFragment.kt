...
class SettingCategoryFragment :
    BaseFragment<SettingCategoryViewModel, FragmentSettingCategoryBinding>(), ItemStartDragListener {
    ...
    override fun onBindingCreated() {
        binding.rvCategory.adapter = SettingCategoryAdapter(viewModel.itemTouchListener, this).apply {
            setHasStableIds(true)
        }
        itemTouchHelper = ItemTouchHelper(ItemMoveCallback(binding.rvCategory.adapter as SettingCategoryAdapter)).apply {
